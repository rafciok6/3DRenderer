...
static void TextFileBufferedRead(const char* filename, char** buffer)
{
	FILE *pfile = NULL;
	*buffer = NULL;
	int count = 0;
...
void OGLShaderProgram::AttachAndCompileShaderFromFile(const char* filename, EShaderType type)
{
